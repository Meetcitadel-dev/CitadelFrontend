  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-8">
      <div className="w-full max-w-md mx-auto text-center">
        <h1 className="text-white text-lg sm:text-xl font-bold leading-tight uppercase" style={{ fontFamily: '"Roboto Serif", serif', textTransform: 'uppercase', textAlign: 'center' }}>

      ...
      <div className="w-full max-w-md mx-auto text-center">
        ...
        <div className="mb-3">
          <svg
            ...
            viewBox="0 0 185 185"
            fill="none"
            className="mx-auto w-32 h-32 sm:w-48 sm:h-48 md:w-56 md:h-56"
          >
        ...
        <h1 className="text-white text-3xl sm:text-4xl font-semibold" style={{ fontFamily: '"Roboto Serif", serif', textAlign: 'center' }}>Citadel</h1>
      </div>
    </div>
  )
}

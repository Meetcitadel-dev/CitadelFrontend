  ...
  return (
    <>
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="relative w-[390px] h-[844px] bg-black rounded-3xl border border-white/10 overflow-hidden">
          <div className="flex flex-col h-full">
            {/* City Image Card with View Bookings Button */}
            <div className="relative flex-shrink-0 h-[260px]">
              <div
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-1.5 px-6 text-center">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/40 text-white text-sm bg-black/30 backdrop-blur-sm hover:bg-black/40 transition-all"
                  >
                  ...
                  {/* City Name */}
                  <h2 className="text-white text-2xl font-bold" style={{ fontFamily: 'serif' }}>
                    {selectedCity}
                  </h2>
                  {primaryArea && (
                    <p className="text-white/80 text-[11px]" style={{ fontFamily: 'Inter' }}>
                      {primaryArea}
                    </p>
                  )}
            ...
            <div className="flex-1 overflow-y-auto px-4 pt-4 pb-5">
              <div className="bg-black/80 rounded-3xl p-4 border border-white/10 shadow-xl">
            {/* Header */}
            ...
            <div className="flex flex-col gap-2.5 mb-5">
              {events.length === 0 ? (
                <div className="text-center py-8">
                  <p className="text-white/70 text-sm">No upcoming events available</p>
                </div>
              ) : (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-white/70 text-xs">{event.eventTime}</div>
                        {event.isBooked && (
                          <div className="mt-0.5 text-[11px] font-medium text-[#1BEA7B]">
                            Already booked
                          </div>
                        )}
                      </div>
              ...
              className={`w-full py-2.5 rounded-full text-white font-semibold transition-all text-sm ${
                  selectedEvent
          ...
          {/* Bottom Navigation */}
          <div className="flex-shrink-0 bg-black/90 border-t border-white/10 px-6 py-3">
